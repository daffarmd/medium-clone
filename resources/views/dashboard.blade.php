        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 text-gray-900">
                @foreach ($posts as $post)
                    <div class="flex flex-col md:flex-row bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-8 overflow-hidden">
                        <div class="p-5 flex-1">
                            ...
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ Str::limit($post->content, 200) }}
                            </p>
                            <a href="#"
                        ...
                        <div class="md:w-48 flex-shrink-0">
                            <img class="w-full h-full object-cover" style="aspect-ratio: 1/1; height: 100%;"
